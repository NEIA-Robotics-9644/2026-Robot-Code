...
public class FlywheelIOTalonFX implements FlywheelIO {
  @Getter private final TalonFX motor;
  ...
  @Override
  public void followFlywheel(FlywheelIO leader, boolean ignoreInvert) {
    motor.setControl(
        new Follower(
            ((FlywheelIOTalonFX) leader).getMotor().getDeviceID(), MotorAlignmentValue.Aligned));

    if (ignoreInvert) {
      motor.setControl(new StrictFollower(((FlywheelIOTalonFX) leader).getMotor().getDeviceID()));
    }
  }
