...
public class TunerConstants {
  ...
  public static Slot0Configs getSteerGains() {
    return new Slot0Configs()
        .withKP(Constants.Drive.STEER_kP.get())
        .withKI(Constants.Drive.STEER_kI.get())
        .withKD(Constants.Drive.STEER_kD.get())
        .withKS(Constants.Drive.STEER_kS.get())
        .withKV(Constants.Drive.STEER_kV.get())
        .withKA(Constants.Drive.STEER_kA.get())
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
  }

  public static Slot0Configs getDriveGains() {
    return new Slot0Configs()
        .withKP(Constants.Drive.DRIVE_kP.get())
        .withKI(Constants.Drive.DRIVE_kI.get())
        .withKD(Constants.Drive.DRIVE_kD.get())
        .withKS(Constants.Drive.DRIVE_kS.get())
        .withKV(Constants.Drive.DRIVE_kV.get())
        .withKA(Constants.Drive.DRIVE_kA.get());
  }
